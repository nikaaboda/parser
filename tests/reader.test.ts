        ...
        describe("Parsing to XML", () => {
            ...
            describe("Order given as a file path", () => {
                test("Parses Order 1 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order1.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER1)
                })
                ...
                test("Parses Order 2 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order2.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER2)
                })
                ...
                test("Parses Order 3 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order3.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER3)
                })
                ...
                test("Parses Order 4 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order4.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER4)
                })
                ...
                test("Parses Order 5 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order5.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER5)
                })
                ...
                test("Parses Order 6 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order6.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER6)
                })
                ...
                test("Parses Order 7 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order7.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER7)
                })
                ...
                test("Parses Order 8 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order8.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER8)
                })
                ...
                test("Parses Order 9 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order9.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER9)
                })
                ...
                test("Parses Order 10 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order10.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER10)
                })
                ...
                test("Parses Order 11 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Orders/Order11.txt", "ORDER", true, "XML");
                    expect(result).toEqual(PARSEDXMLORDER11)
                })
            });
            ...
            describe("Invoice given as a file path", () => {
                test("Parses Invoice 1 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Invoices/Invoice1.txt", "INVOICE", true, "XML");
                    expect(result).toEqual(PARSEDXMLINVOICE1)
                })
                ...
                test("Parses Invoice 2 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Invoices/Invoice2.txt", "INVOICE", true, "XML");
                    expect(result).toEqual(PARSEDXMLINVOICE2)
                })
                ...
                test("Parses Invoice 3 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Invoices/Invoice3.txt", "INVOICE", true, "XML");
                    expect(result).toEqual(PARSEDXMLINVOICE3)
                })
                ...
                test("Parses Invoice 4 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Invoices/Invoice4.txt", "INVOICE", true, "XML");
                    expect(result).toEqual(PARSEDXMLINVOICE4)
                })
                ...
                test("Parses Invoice 5 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Invoices/Invoice5.txt", "INVOICE", true, "XML");
                    expect(result).toEqual(PARSEDXMLINVOICE5)
                })
                ...
                test("Parses Invoice 6 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Invoices/Invoice6.txt", "INVOICE", true, "XML");
                    expect(result).toEqual(PARSEDXMLINVOICE6)
                })
                ...
                test("Parses Invoice 7 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Invoices/Invoice7.txt", "INVOICE", true, "XML");
                    expect(result).toEqual(PARSEDXMLINVOICE7)
                })
                ...
                test("Parses Invoice 8 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Invoices/Invoice8.txt", "INVOICE", true, "XML");
                    expect(result).toEqual(PARSEDXMLINVOICE8)
                })
                ...
                test("Parses Invoice 9 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Invoices/Invoice9.txt", "INVOICE", true, "XML");
                    expect(result).toEqual(PARSEDXMLINVOICE9)
                })
            });
            ...
            describe("Deasdv given as a file path", () => {
                test("Parses Deasdv 1 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Deasdvs/Deasdv1.txt", "DEASDV", true, "XML");
                    expect(result).toEqual(PARSEDXMLDEASDV1)
                })
                ...
                test("Parses Deasdv 2 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Deasdvs/Deasdv2.txt", "DEASDV", true, "XML");
                    expect(result).toEqual(PARSEDXMLDEASDV2)
                })
                ...
                test("Parses Deasdv 3 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Deasdvs/Deasdv3.txt", "DEASDV", true, "XML");
                    expect(result).toEqual(PARSEDXMLDEASDV3)
                })
                ...
                test("Parses Deasdv 4 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Deasdvs/Deasdv4.txt", "DEASDV", true, "XML");
                    expect(result).toEqual(PARSEDXMLDEASDV4)
                })
                ...
                test("Parses Deasdv 5 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Deasdvs/Deasdv5.txt", "DEASDV", true, "XML");
                    expect(result).toEqual(PARSEDXMLDEASDV5)
                })
                ...
                test("Parses Deasdv 6 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Deasdvs/Deasdv6.txt", "DEASDV", true, "XML");
                    expect(result).toEqual(PARSEDXMLDEASDV6)
                })
                ...
                test("Parses Deasdv 7 correctly", () => {
                    ...
                    const result = reader.read("../static/StratEDI/Deasdvs/Deasdv7.txt", "DEASDV", true, "XML");
                    expect(result).toEqual(PARSEDXMLDEASDV7)
                })
            });
        })
