        ...
        describe("Parsing to XML", () => {
            describe("Order given as a string", () => {
                test("Parses Order 1 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER1, "ORDER", false);
                ...
                test("Parses Order 2 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER2, "ORDER", false);
                ...
                test("Parses Order 3 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER3, "ORDER", false);
                ...
                test("Parses Order 4 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER4, "ORDER", false);
                ...
                test("Parses Order 5 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER5, "ORDER", false);
                ...
                test("Parses Order 6 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER6, "ORDER", false);
                ...
                test("Parses Order 7 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER7, "ORDER", false);
                ...
                test("Parses Order 8 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER8, "ORDER", false)
                ...
                test("Parses Order 9 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER9, "ORDER", false);
                ...
                test("Parses Order 10 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER10, "ORDER", false);
                ...
                test("Parses Order 11 correctly", () => {
                    ...
                    const result = reader.read(RAWORDER11, "ORDER", false);
            ...
            describe("Invoice given as a string", () => {
                test("Parses Invoice 1 correctly", () => {
                    ...
                    const result = reader.read(RAWINVOICE1, "INVOICE", false);
                ...
                test("Parses Invoice 2 correctly", () => {
                    ...
                    const result = reader.read(RAWINVOICE2, "INVOICE", false);
                ...
                test("Parses Invoice 3 correctly", () => {
                    ...
                    const result = reader.read(RAWINVOICE3, "INVOICE", false);
                ...
                test("Parses Invoice 4 correctly", () => {
                    ...
                    const result = reader.read(RAWINVOICE4, "INVOICE", false);
                ...
                test("Parses Invoice 5 correctly", () => {
                    ...
                    const result = reader.read(RAWINVOICE5, "INVOICE", false);
                ...
                test("Parses Invoice 6 correctly", () => {
                    ...
                    const result = reader.read(RAWINVOICE6, "INVOICE", false);
                ...
                test("Parses Invoice 7 correctly", () => {
                    ...
                    const result = reader.read(RAWINVOICE7, "INVOICE", false);
                ...
                test("Parses Invoice 8 correctly", () => {
                    ...
                    const result = reader.read(RAWINVOICE8, "INVOICE", false)
                ...
                test("Parses Invoice 9 correctly", () => {
                    ...
                    const result = reader.read(RAWINVOICE9, "INVOICE", false);
            ...
            describe("Deasdv given as a string", () => {
                test("Parses Deasdv 1 correctly", () => {
                    ...
                    const result = reader.read(RAWDEASDV1, "DEASDV", false);
                ...
                test("Parses Deasdv 2 correctly", () => {
                    ...
                    const result = reader.read(RAWDEASDV2, "DEASDV", false);
                ...
                test("Parses Deasdv 3 correctly", () => {
                    ...
                    const result = reader.read(RAWDEASDV3, "DEASDV", false);
                ...
                test("Parses Deasdv 4 correctly", () => {
                    ...
                    const result = reader.read(RAWDEASDV4, "DEASDV", false);
                ...
                test("Parses Deasdv 5 correctly", () => {
                    ...
                    const result = reader.read(RAWDEASDV5, "DEASDV", false);
                ...
                test("Parses Deasdv 6 correctly", () => {
                    ...
                    const result = reader.read(RAWDEASDV6, "DEASDV", false);
                ...
                test("Parses Deasdv 7 correctly", () => {
                    ...
                    const result = reader.read(RAWDEASDV7, "DEASDV", false);
